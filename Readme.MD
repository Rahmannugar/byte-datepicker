...
![Year Selection](https://raw.githubusercontent.com/Rahmannugar/byte-datepicker/main/docs/year-selection.png)

### Disabled State

```tsx
<ByteDatePicker disabled={true} placeholder="This picker is disabled" />
```
