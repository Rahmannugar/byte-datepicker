...
The render prop provides `open`, `isOpen`, `selectedTime`, `formattedValue`, and `clear`.
...
The render prop provides `open`, `isOpen`, `selectedDateTime`, `formattedValue`, and `clear`.
